...
/*
 ...
 use listener chain: Serial Socket-> serial service -> ui fragment
    ...
    public void attach(SerialListener listener) {
        ...
        for(QueueItem item : queue1) {
            ...
            switch(item.type) {
                ...
                case Read:
                    Log.i("here", "attach:+woah ");
                    Log.i("hereSee", "attach: "+item.data.toString());
                    listener.onSerialRead(item.data); break;
